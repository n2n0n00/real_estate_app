...
const Banner = ({ purpose, title1, title2, desc1, buttonText, desc2, linkName, imageUrl }) => (
...
export default function Home({ propertyForRent, propertyForSale }) {
  ...
  return (
    <Box>
      ...
      <Flex flexWrap="wrap">
        {propertyForRent.map((property) => <Property property={property} key={property.key} />)}
      </Flex>
      ...
      <Flex flexWrap="wrap">
        {propertyForSale.map((property) => <Property property={property} key={property.key} />)}
      </Flex>
